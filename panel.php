			...
			if (this.readyState == 4) {
				if (this.status == 200) {
					if (this.responseXML != null) {
						...
						if(this.responseXML.getElementsByTagName('LED2')[0].childNodes[0].nodeValue == "1") {
                                                        document.getElementById("LED2").innerHTML = "ON";
                                                        document.LED_form1.LED2.checked = true;
                                                }else if(this.responseXML.getElementsByTagName('LED2')[0].childNodes[0].nodeValue =="0"){
                                                        document.getElementById("LED2").innerHTML = "OFF";
                                                        document.LED_form1.LED2.checked = false;
                                                }
						if(this.responseXML.getElementsByTagName('LED3')[0].childNodes[0].nodeValue == "1") {
                                                        document.getElementById("LED3").innerHTML = "ON";
                                                        document.LED_form1.LED3.checked = true;
                                                }else if(this.responseXML.getElementsByTagName('LED3')[0].childNodes[0].nodeValue =="0"){
                                                        document.getElementById("LED3").innerHTML = "OFF";
                                                        document.LED_form1.LED3.checked = false;
                                                }
						if(this.responseXML.getElementsByTagName('LED4')[0].childNodes[0].nodeValue == "1") {
                                                        document.getElementById("LED4").innerHTML = "ON";
                                                        document.LED_form1.LED4.checked = true;
                                                }else if(this.responseXML.getElementsByTagName('LED4')[0].childNodes[0].nodeValue =="0"){
                                                        document.getElementById("LED4").innerHTML = "OFF";
                                                        document.LED_form1.LED4.checked = false;
                                                }
						if(this.responseXML.getElementsByTagName('Door')[0].childNodes[0].nodeValue == "0") {
                                                        document.getElementById("puerta").innerHTML = "La puerta esta cerrada";
                                                }else if(this.responseXML.getElementsByTagName('Door')[0].childNodes[0].nodeValue =="1"){
                                                        document.getElementById("puerta").innerHTML = "La puerta esta abierta";
                                                }// ----------------------------------------------------------------------------------------------------------
					}//if responseXML
				}//if 200
			}//if 4
...
?>
        <div class="main_page">
        <h1 id="load">Web  IoT Internet de las Cosas[Casa de Fulanito]<br>(Entrada de Datos)</h1>
        <div class="IO_box">
			<h2>Analog Inputs</h2>
...
<!----------------------------------------------------------------------------------------------------------------------!>
		<div class="IO_box">
			...
			<button type="button" id="LED33" onclick="GetButton1()">LED 3 is OFF (D8)</button><br /><br />
			<button type="button" id="LED43" onclick="GetButton2()">LED 4 is OFF (D9)</button><br /><br />
...
<!----------------------------------------------------------------------------------------------------------------------!>
		<div class="out_box">
			...
			<div class="error" id="ventilador"></div><br>
			<form action=""><label for="dor"><h3>Puerta principal</h3></label> 	
				<select name="door" onchange="comandoP(this.value)">
					<option value="">Diga:</option>
					<option value="1">Abrir Puerta</option>
					<option value="0">Cerrar Puerta</option>
				</select>
				<div class="error" id="puerta"></div>
			</form>
			<div class="error" id="puerta"></div>
		</div>
<!----------------------------------------------------------------------------------------------------------------------!>
		<div class="out_box">
			<form class="check_LEDs" name="LED_form1">
				<input type="checkbox" name="LED1" value="0" onclick="GetCheck('LED1', this)" />LED1 (D26)<div class="error" id="LED1"></div>
				<input type="checkbox" name="LED2" value="0" onclick="GetCheck('LED2', this)" />LED2 (D27)<div class="error" id="LED2"></div><br />
				<input type="checkbox" name="LED3" value="0" onclick="GetCheck('LED3', this)" />LED3 (D28)<div class="error" id="LED3"></div>
				<input type="checkbox" name="LED4" value="0" onclick="GetCheck('LED4', this)" />LED4 (D29)<div class="error" id="LED4"></div>
			</form>
		</div>
<!----------------------------------------------------------------------------------------------------------------------!>
		<div class="out_box">
